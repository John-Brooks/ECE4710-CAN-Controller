...
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { bit_clock }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { LED_0 }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { LED_1 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { raw }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
